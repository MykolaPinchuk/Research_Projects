...
### Some of these tables and figures will be generated now, some will be created 
### at the end of the script in 'Results' and  'Feature importance' sections
...
# I randomly pick 100,000 observations after 1990 for test sample.
# due to traders using past data to learn patters, I do not want to use future data to train the model nd past data to evaluate it.
# so ideally, I will need to do rolling-window train/test splits, but for now it is computationally infeasible,
# so i use all data before 1990 and most data after 1990 for train data and only data after 1990 for test data.
# i can not pick the last x years as test data, since there are year-long pattern in stock returns
# (e.g., in 2017-2018 it firms will have very high returns) leading to excessive noise.
